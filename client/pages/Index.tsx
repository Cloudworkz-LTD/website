    ...
    <div className="min-h-screen bg-white overflow-x-hidden relative">
      ...
      <section className="relative w-full overflow-visible pt-[120px] md:pt-[180px] lg:pt-[220px] px-4 md:px-6 lg:pl-[40px]">
        <div className="relative w-full min-h-[400px] md:min-h-[600px] lg:min-h-[800px]">
          ...
          {/* Content above image */}
          <StaggerContainer
            className="relative z-[60] flex flex-col lg:flex-row items-end gap-8 md:gap-12 lg:gap-16 max-w-none w-full mt-auto"
            stagger={0.4}
            delay={0.2}
          >
            {/* Left content */}
            <div className="flex flex-col items-start gap-1 md:gap-2 flex-1 pb-12 md:pb-16 lg:pb-20">
              <JustifiedRevealText
                splitBy="words"
                stagger={0.08}
                delay={0.2}
            ...
            <div className="flex-shrink-0 w-full lg:w-auto flex items-start">
              <div className="relative w-full max-w-[400px] md:max-w-[500px] lg:w-[580px] h-[240px] md:h-[300px] lg:h-[348px] mx-auto lg:mx-0 mt-16 md:mt-24 lg:mt-32">
                <svg
                  width="100%"
                  height="100%"
                  viewBox="0 0 580 348"
