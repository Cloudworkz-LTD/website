    ...
    <div className="min-h-screen bg-white overflow-x-hidden relative">
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 md:gap-2 lg:gap-0 w-full max-w-[1356px] overflow-hidden">
          ...
          >
            <h3 className="font-kenyan text-[70px] md:text-[70px] lg:text-[90px] font-normal leading-[100%] tracking-[-1.8px] uppercase text-white">
              Start with the problem
            </h3>
            <p className="font-archivo text-xl md:text-lg lg:text-xl font-normal leading-[100%] text-white">
        ...
        <div className="relative w-full min-h-[400px] md:min-h-[600px] lg:min-h-[800px]">
          ...
          >
            ...
            <div className="flex flex-col items-start flex-1 gap-0">
              ...
              <FadeInUp delay={0.4} className="mt-4 md:mt-6 lg:mt-8">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center lg:justify-between gap-8 lg:gap-[31px]">
                ...
                >
                  ...
                  {/* Description */}
                  <FadeInUp y={30}>
                    <p className="text-center lg:text-right text-cloudworkz-black font-archivo font-semibold text-sm md:text-lg lg:text-xl xl:text-[24px] leading-[1.1] max-w-full lg:max-w-3xl uppercase">
